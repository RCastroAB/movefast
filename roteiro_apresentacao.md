...
2. Busque "Network Effects," ou produtos cujo valor escala de forma combinatória em relação ao número de usuários.
    ...
    * Um exemplo obvio é um aplicativo de namoro como o Tinder, onde a utilidade do aplicativo para o usuário depende do número de outros usuários compatíveis já estão no sistema. Uma competição contra o Match Group necessitaria que o seu serviço sempre tivesse um número comparável de usuários para qualquer lugar na sua área de cobertura, ou que o sistema fosse de alguma forma muito superior (e mais lucrativo) em relação aos aplicativos dessa empresa.
...
4. Construa uma boa marca.
    ...
    * O maior inimigo de uma empresa monopolista é sempre o governo e seus departamentos anti-trust, que é fortemente influenciado pela pressão popular. Então é de máxima importancia que a população esteja do lado da sua empresa para evitar situações como a da [Standard Oil](https://en.wikipedia.org/wiki/Standard_Oil), e foi assim por exemplo que a [Microsoft evitou ser quebrada](https://en.wikipedia.org/wiki/United_States_v._Microsoft_Corp.) em várias pequenas empresas em 2001 em um processo anti-trust.
...
Cooperando entre si, ambas empresas podem adotar práticas anti-competitivas como a [Web Environment Integrity API](https://arstechnica.com/gadgets/2023/07/googles-web-integrity-api-sounds-like-drm-for-the-web/) ou a desabilitação de funcionalidades essenciais usadas por adBlockers (a fonte primária de renda da Google é propagandas) e outras extensões bloqueadoras de conteúdo no [Manifest
